                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                    <div class="footer-widgets">
                        <div class="footer-logo">
                            <a href="index.php"><img src="<?php echo get_template_directory_uri();?>/media/logo-dark.png" alt="Logo"></a>
                        </div>
                ...
                <div class="col-xl-2 d-none d-xl-block">
                    <div class="footer-widgets">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="about.php">About Vikgol</a></li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                    <div class="footer-widgets">
                        ...
                        <ul class="footer-contact">
                            <li><i class="flaticon-placeholder"></i>#265, 6th Main, 4th Cross, Stage 2, BTM Layout, Bengaluru, Karnataka 560076</li>
                            <li><i class="flaticon-plane"></i>contact@vikgol.com</li>
                            <li><i class="flaticon-telephone"></i>+91 9940 526 611</li>
                        </ul>
                    </div>
                </div>
            </div>
